...
@Component({
  selector: 'app-alumnos-profe',
  templateUrl: './alumnos-profe.component.html',
  styleUrls: ['./alumnos-profe.component.css']
})
export class AlumnosProfeComponent implements OnInit {
  ...
  constructor(private db: AngularFirestore, private storage: AngularFireStorage) { 
    ...
    this.coleccionTipadaFirebase= this.db.collection<any>('inscripciones', ref => ref.where("emailProfesor", "==", email)); 
